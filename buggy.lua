...
function Quantum.Build(Config)
    ...
    -- Smooth Close dengan Confirmation
    ...
    function Window:AddTab(Name, Icon)
        ...
        function TabAPI:AddButton(LabelText, Callback, Extra)
            ...
            Btn.MouseLeave:Connect(function()
                Btn.BackgroundColor3 = Quantum.ThemePalettes[Window.CurrentTheme].Accent
            end)
            ...
            local function BuildItems(items)
                ...
                for i, item in ipairs(items) do
                    ...
                    B.MouseEnter:Connect(function() 
                        if PendingBtn ~= B then B.BackgroundColor3 = Color3.fromRGB(45, 45, 55); B.BackgroundTransparency = 0.3 end
                    end)
                    B.MouseLeave:Connect(function() 
                        if PendingBtn ~= B then B.BackgroundTransparency = 1 end
                    end)
                    B.MouseButton1Click:Connect(function()
