...
local MinBtn = Make("TextButton", {
    ...
    function Window:Notify(NConfig)
        ...
        local Logo = Make("ImageLabel", {Parent = TopContent, Size = UDim2.new(0, 28, 0, 28), BackgroundTransparency = 1, ImageTransparency = 1, Image = "rbxassetid://124401172460903"}, { Make("UICorner", {CornerRadius = UDim.new(1, 0)}) })
    ...
    function Window:PlayIntro(IntroConfig)
        ...
        local IntroLogo = Make("ImageLabel", {Parent = CenterFrame, Image = "rbxassetid://124401172460903", Size = UDim2.new(0, 120, 0, 120), BackgroundTransparency = 1, ImageTransparency = 1, LayoutOrder = 1}, { Make("UICorner", {CornerRadius = UDim.new(1, 0)}) })
